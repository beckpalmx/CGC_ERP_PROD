...
<html>
        ...
        <script type="text/javascript">
            ...
            function goDelChild()
            {
                ...
                else//จะทำการลบข้อมูลเฉพาะ Datail ที่ทำการเลือกไว้
                {
                    ...
                    //alert("SURL = " + SURL);
                    //alert("ลบข้อมูลรายการที่ : " + Deleteflag);
                    Delete_Line_no(SURL);
                    showTableNonPopup("show2", "doc_id", "../JSP/CS_Show033.jsp?doc_id=");
                    if (getId("status_cancle").value === "1") {
            ...
            function CreateNewRow()
            {
                ...
                newCell.setAttribute("class", "forborder");
                newCell.innerHTML = "<td><INPUT TYPE=\"text\" style=\"font-weight: bold\" class=\"inputs\" SIZE=\"20\" NAME=\"param" + (intLine + 14) + "\" ID=\"param" + (intLine + 14) + "\" VALUE=\"PSD\" ></td>";
                newCell = newRow.insertCell(3);
                newCell.setAttribute("width", "25%");
                newCell.setAttribute("class", "forborder");
                newCell.innerHTML = "<td><INPUT TYPE=\"text\" style=\"font-weight: bold\" class=\"inputs\" SIZE=\"20\" NAME=\"method" + (intLine + 14) + "\" ID=\"method" + (intLine + 14) + "\" VALUE=\"\" ></td>";
                newCell = newRow.insertCell(4);
                newCell.setAttribute("width", "20%");
                newCell.setAttribute("class", "forborder");
                newCell.innerHTML = "<td><INPUT TYPE=\"text\" style=\"font-weight: bold\" class=\"inputs\" SIZE=\"20\" NAME=\"spec" + (intLine + 14) + "\" ID=\"spec" + (intLine + 14) + "\" VALUE=\"\" ></td>";
                newCell = newRow.insertCell(5);
                newCell.setAttribute("width", "20%");
                newCell.setAttribute("class", "forborder");
                newCell.innerHTML = "<td><INPUT TYPE=\"text\" style=\"font-weight: bold\" class=\"inputs\" SIZE=\"20\" NAME=\"add_desc" + (intLine + 14) + "\" ID=\"add_desc" + (intLine + 14) + "\" VALUE=\"\" ></td>";
                getId("maxline").value = intLine;
            }
            function RemoveRow()
            {
                var intLine = parseInt(getId("maxline").value);
                //alert("intLine = " + intLine);
            ...
            function Last_Doc_id() {
                AjaxRun_id("doc_id_last", "../JSP/CS_032_RUN_DOC_ID.jsp?runer_id=1");
            }
    ...
    <!--body onkeyup="Start_Refresh_Detail()"-->
    <body onload="Start_Check_Last_Doc_ID();">
        <form name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">
            <%
                ...
                String inputSQL = " select doc_id as Field from d_job_order_header where delete_flag = 'N' order by runno desc limit 1 ";
                doc_id_last = objuti.GetField(inputSQL);
                            ...
                            <table  cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    <td colspan="2" align="left">
                                        <span class="label label-success">เลขที่เอกสารล่าสุด : </span>                                            
                                        &nbsp;<input name='doc_id_last'  data-toggle="tooltip" title="กดเพื่อดูเลขที่เอกสารล่าสุด หรือรอเพื่อ Update อัตโนมัติ" type='button' class="cgcButton_21" id="doc_id_last" value='<%=doc_id_last%>'onclick="Last_Doc_id();"/>                                            
                                    </td>
                                </tr>                                            
                                <tr>
                                ...
                                <tr>
                                    <td width="150" class="columnlabel1"><b>เอกสารที่จบใบแจ้งฯแล้ว*</b>&nbsp;:&nbsp;</td>
                                    <td width="607" class="columnobject">                                            
                                        &nbsp;<a href='javascript:;' onClick="openBrWindow('vd_job_order_header&stadment=and+complete_flag+=+\'Y\'', 32, 'Search_Doc_id.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;
                                </tr>                                    
                                <tr>
                                    <td class="columnlabel1"><b>เลขที่ใบสั่งซื้อ*</b>&nbsp;:&nbsp;</td>
                                    <td class="columnobject">
                                        <input name='po_no' type='text' class="inputs" id="po_no" value='' size='20' />
                                        &nbsp;<a href='javascript:;' onClick="openBrWindow('vd_saleorderproduct_detail&stadment=and+(doc_type+<>+\'Y\'+or+doc_type+is+null)', 32, 'Search_Config2.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' ></a>
                                        &nbsp;&nbsp;<input name='po_no_befor' type='text' class="inputs" id="po_no_befor" value='' size='20' />
                                    </td>
                                </tr>                                    
                                <tr>
                                    <td class="columnlabel1"><b>ผู้ซื้อ*</b>&nbsp;:&nbsp;</td>
                                    <td class="columnobject">
                                        <input name='cust_id' type='text' class="inputs" id="cust_id" value='' size='20' readonly />
                                        &nbsp;<a href='javascript:;' onClick="openBrWindow('Vcustomer', 32, 'Search_Config2.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;<input name='cust_id_desc' type='text' class="inputs" id="cust_id_desc" value='' size='50' readonly/>	          	
                                    </td>
                                </tr>

                                <tr>
                                    <td class="columnlabel1"><b>กำหนดเข้าตู้ / ขึ้นรถบรรทุก*</b>&nbsp;:&nbsp;</td>
                                    <td class="columnobject">
                                ...
                                <tr>
                                    <td class="columnlabel1"><b>กำหนดเป็น LOT NO*</b>&nbsp;:&nbsp;</td>
                                    <td class="columnobject">
                                        <input name='lot_no' type='text' class="inputs" id="lot_no" value='' size='20' />	          	
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="columnlabel1"><b>มีสินค้าใน Stock จำนวน</b>&nbsp;:&nbsp;</td>
                                    <td class="columnobject">
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        ...
                                        <div  id="show" style="width:100%;">
                                            <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner">
                                                <tr>
                                                    <td class="headergrid" colspan="17"><b>ข้อมูลการผลิต</b></td>
                                                </tr>   
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="forborder" width="25%"><input name='param1' type='text' style="font-weight: bold" class="inputs" id="param1" value='ชนิด/ขนาด' size=20 readonly='readonly' /></td>
                                                    <td class="forborder" width="25%"><input name='method1' type='text' class="inputs" id="method1" value='' size=20 /></td>
                                                    <td class="forborder" width="20%"><input name='spec1' type='text' class="inputs" id="spec1" value='' size=20 onclick="openBrWindow('vm_carbon_size&textinput=spec1', 32, 'Search_Detail_Carbon_Size.jsp');" readonly/></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="forborder" width="25%"><input name='param2' type='text' style="font-weight: bold" class="inputs" id="param2" value='จำนวน(ตัน)' size=20 readonly='readonly' /></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="forborder" width="25%"><input name='param3' type='text' style="font-weight: bold" class="inputs" id="param3" value='รหัสสินค้า(CGC)' size=20 readonly='readonly' /><!--&nbsp;<a href='javascript:;' onClick="openBrWindow('d_saleorderproduct_detail&stadment=and+doc_id+=+\''+getId('po_no').value+'\'',32, 'Search_Config2.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' ></a>--></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="forborder" width="25%"><input name='param4' type='text' style="font-weight: bold" class="inputs" id="param4" value='การบรรจุ(กระสอบ)' size=20 readonly='readonly' /></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="forborder" width="25%"><input name='param5' type='text' style="font-weight: bold" class="inputs" id="param5" value='น้ำหนักบรรจุ' size=20 readonly='readonly' /></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="forborder" width="25%"><input name='param6' type='text' style="font-weight: bold" class="inputs" id="param6" value='Butane' size=20 readonly='readonly' /></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="forborder" width="25%"><input name='param7' type='text' style="font-weight: bold" class="inputs" id="param7" value='CTC' size=20 readonly='readonly' /></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="forborder" width="25%"><input name='param8' type='text' style="font-weight: bold" class="inputs" id="param8" value='I2' size=20 readonly='readonly' /></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="forborder" width="25%"><input name='param9' type='text' style="font-weight: bold" class="inputs" id="param9" value='Methylene Blue' size=20 readonly='readonly' /></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="forborder" width="25%"><input name='param10' type='text' style="font-weight: bold" class="inputs" id="param10" value='Moisture Content' size=20 readonly='readonly' /></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="forborder" width="25%"><input name='param11' type='text' style="font-weight: bold" class="inputs" id="param11" value='Ash' size=20 readonly='readonly' /></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="forborder" width="25%"><input name='param12' type='text' style="font-weight: bold" class="inputs" id="param12" value='pH' size=20 readonly='readonly' /></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="forborder" width="25%"><input name='param13' type='text' style="font-weight: bold" class="inputs" id="param13" value='Bulk Density' size=20 readonly='readonly' /></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="forborder" width="25%"><input name='param14' type='text' style="font-weight: bold" class="inputs" id="param14" value='Hardness' size=20 readonly='readonly' /></td>
                                            ...
                                            <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner">
                                                <tr>
                                                    ...
                                                    <td colspan="3" class="btn_multi">
                                                        ...
                                                        <input type='button' class="cgcButton_7" name='but3' value='  Refresh  ' onclick='Refresh_Detail();'/>
                                                    </td>
                                                </tr>
                                                <tr>
                                ...
                                <tr>
                                    <td class="columnlabel1"><b>จำนวน</b>&nbsp;:&nbsp;</td>
                                    <td class="columnobject">
                                ...
                                <tr>
                                    <td class="columnlabel1"><b>ฝ่ายขาย</b>&nbsp;:&nbsp;</td>
                                ...
                                <tr>
                                    <td class="columnlabel1"><b>ฝ่ายวิเคราะห์คุณภาพ</b>&nbsp;:&nbsp;</td>
                                ...
                                <tr>
                                    <td class="columnlabel1"><b>ฝ่ายผลิต</b>&nbsp;&nbsp;:&nbsp;</td>
                                ...
                                <tr>
                                    <td class="columnlabel1"><b>ฝ่ายคลังสินค้า</b>&nbsp;:&nbsp;</td>
