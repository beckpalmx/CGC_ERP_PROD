...
<html>
    <head>
        ...
        <script type="text/javascript">
            function goAdd()
            {
                ...
                {
                    getSave(URLsend('doc_id,doc_type,doc_date,product_id,location_id,weight,wh_in,status_a,username', '../JSP/CS_116.jsp'));
            ...
            function goDelete()
            {
                if (confirm("ต้องการลบข้อมูล ?")) {
                    getSave(URLsend('doc_id,product_id,location_id,weight,wh_in,line_no,status_d,username', '../JSP/CS_116.jsp'));
                    opener.getId("doc_id").disabled = true;
                    showTable("show", "doc_id", "../JSP/CS_Show116.jsp?doc_id=");
                    setTimeout('showTable("show","doc_id","../JSP/CS_Show116.jsp?doc_id=")', 800);
                    setTimeout('window.close()', 1500);
    ...
    <body>
        <%!        ThaiUtil en = new ThaiUtil();
            ...
            String doc_id,doc_type,doc_date,line_no, status_a, status_u, product_id, product_id_desc, pgroup_name, pcat_name, location_id, weight, wh_in, wh_in_desc, remark;
        %>
        <%
            doc_id = "";
            product_id = "";
                        ...
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    ...
                                    &nbsp;<a href='#' onClick="javascript:openBrWindow('vproduct', 116, 'Search_Config2_1.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;<input name='product_id_desc' type='text' class="inputs" id="product_id_desc" value='<%=product_id_desc%>' size='70' readonly="readonly" />                                </td>
                            </tr>
                            <tr>
                            ...
                            <!--tr>
                                ...
                                <td class="columnobject">
                                    <input name='remark' type='text' class="inputs" id="remark" value='<%=remark%>' size='80' />     
                                </td>
                            </tr-->                            
