...
<html>
    <head>
        ...
        <script type="text/javascript">
            function goAdd() {
                ...
                {
                    getSave(URLsend('doc_id,wh_id,product_id,size,i2,bag,weight,remark,status_a,username,product_no,weight_unit,pack_repacking_status,carbon_trap_status,doc_type', '../JSP/CS_044_1.jsp'));
                    showTable("show2", "doc_id", "../JSP/CS_Show044_1.jsp?doc_id=");
                    setTimeout('showTable("show2","doc_id","../JSP/CS_Show044_1.jsp?doc_id=")', 800);
            ...
            function goEdit()
            {
                ...
                if (ChkParameter(arrayChk))
                {
                    getSave(URLsend('doc_id,line_no,wh_id,product_id,size,i2,bag,weight,remark,status_u,username,product_no,weight_unit,pack_repacking_status,carbon_trap_status,doc_type', '../JSP/CS_044_1.jsp'));
                    showTable("show2", "doc_id", "../JSP/CS_Show044_1.jsp?doc_id=");
                    setTimeout('showTable("show2","doc_id","../JSP/CS_Show044_1.jsp?doc_id=")', 800);
                    setTimeout('window.close()', 1000);
                }
    ...
    <%!    ThaiUtil en = new ThaiUtil();
        D_packing_product_detail_prodDAO_40_1 objDAO = new D_packing_product_detail_prodDAO_40_1();
                    ...
                    <div class="panel-footer">           
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    <input name='size' type='text' class="inputs" id="size" value='<%=size%>' size='10' readonly/>&nbsp;<a href='#' onClick="javascript:openBrWindow('m_carbon_size', 44, 'Search_Config_Integer.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;<input name="size_desc" type='text' class="inputs" id="size_desc" size="30" value="<%=size_name%>" readonly></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="columnobject"><input name='weight' type='text' class="inputs" id="weight" value='<%=weight%>' size='10' onblur="IsNuber(this.value, this)"/>
                                    &nbsp;(กิโลกรัม) </td>
                            </tr>
                            <tr>
                                <td class="columnlabel1">น้ำหนัก/หน่วย&nbsp;:&nbsp;</td>
                                <td class="columnobject"><input name="weight_unit" type='text' class="inputs" id="weight_unit" size="10" value="<%=weight_unit%>" onblur="IsNuber(this.value, this)">
                                    &nbsp;(กิโลกรัม) </td>
                            </tr>
                            <tr>
