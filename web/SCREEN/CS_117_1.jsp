...
<html>
    <head>
        ...
        <script type="text/javascript">
            function goAdd()
            {
                ...
                {
                    getSave(URLsend('doc_id,doc_date,doc_type,product_id,location_id,weight,wh_in,status_a,username', '../JSP/CS_117_1.jsp'));
    ...
    <body>
        <%!        ThaiUtil en = new ThaiUtil();
            ...
            String doc_id,doc_type,doc_date,line_no, status_a, status_u, product_id, product_id_desc, pgroup_name, pcat_name, location_id, weight, wh_in, wh_in_desc;
        %>
        <%
            doc_id = "";
            product_id = "";
            ...
            if (request.getQueryString().indexOf("line_no_") != -1) {
                ...
                doc_id = en.EncodeTexttoTIS(request.getParameter("doc_id"));
                doc_type = en.EncodeTexttoTIS(request.getParameter("doc_type"));
                doc_date = en.EncodeTexttoTIS(request.getParameter("doc_date"));
