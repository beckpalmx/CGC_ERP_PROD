...
<html>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function OpenConfirm_WH(table, URL, dept_id,dept_id2) {
                table += "&stadment=and+emp_id+=+\'" + getId("emp_id").value + "\'+and+(dept_id+=+\'" + dept_id 
                      + "\'+or+dept_id+=+\'" + dept_id2 + "\')";
                openBrWindow(table, 32, URL);
            }            
                            ...
                            <table  cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    ...
                                    <td class="columnobject"><input name='wh_dep' type='text' class="inputs" id="wh_dep" value='' size='10' readonly/>
                                        <a href='javascript:;'onclick="OpenConfirm_WH('Vemployee3', 'Search_Config2.jsp', '05','006')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE6' width='20' height='20' border='0' align='middle' ></a>
