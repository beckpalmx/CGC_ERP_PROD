...
//                    alert("Delete ALL");
            ...
            function Record_Count() {
                AjaxRun_id("record_count1", "../JSP/CS_D_Carbon_Send_Count_Doc.jsp?runer_id=1");
            }
    ...
    <body onload="Start_Check_Record_Count()" >
        ...
        <form name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">
            <%
                ...
                String inputSQL = " select count(*) as num from vd_carbon_send_product_header where doc_type = 'PM' and  quality_confirm <> 'Y'   " ;
