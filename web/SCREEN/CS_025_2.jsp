    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function Record_Count() {
                AjaxRun_id("record_count1", "../JSP/CS_D_RawMat_Count_Doc.jsp?runer_id=1");
            }
    ...
    <body onload="Start_Check_Record_Count();">
        <form name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">
            ...
            <%
                ...
                String inputSQL = " select count(*) as num from d_carbon_friction_header where complete_flag <> 'Y' ";
