 ...
 * @author Beck
 */
public class PrintCSV_CARBON_OUT {
...
//                    + objMdata_export.getLookup_name();
            ...
            SQL = " Select doc_year,doc_month,size,rawmatt_id,burn_no,sum(to_number(weight,'9,999,999.99')) as sum_weight From ";
            SQL += objMdata_export.getLookup_name();
            SQL += Statement_where;
            SQL += " Group By doc_year,doc_month,rawmatt_id,size,burn_no";
        ...
        try {
            ...
            System.out.println("Param Name" + objMdata_export.getParam_name());
            System.out.println("Param Value" + Return_param_value);
