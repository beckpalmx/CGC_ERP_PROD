    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            /*            
             ...
             {
             if (getId("A_complete_flag").value == "N") {
             
             var r = confirm("คุณต้องการพิมพ์เอกสารและส่งข้อมูลเข้า Store หรือไม่ ?")
             if (r)
             {
            ...
            function cancle()
            {
                location.replace("CS_D_carbon_send_product_header2_analyze.jsp");
            }
...
//                    alert("Delete ALL");
            ...
            /*            
             ...
             if (getId("chk_all").checked)//จะทำการลบข้อมูลของ Detail ทั้งหมด ทึ่ตรงกับรหัส
             {
             var r = confirm("คุณต้องการลบข้อมูลรายละเอียดของเอกสารนี้ใช่หรือไม่")
             if (r) {
             SURL = "../JSP/CS_Detail_D_carbon_send_product_analyze.jsp?status_d=3&chk_all=1&username=" + getId("A_username").value;
             SURL = SURL + "&A_doc_id=" + getId("A_doc_id").value;
             Delete_Line_no(SURL);
             ...
             Delete_Line_no(SURL);                        
             showTableNonPopup("show", "A_doc_id", "../JSP/CS_ShowD_carbon_send_product_analyze.jsp?doc_id=");
             setTimeout('showTableNonPopup("show", "A_doc_id", "../JSP/CS_ShowD_carbon_send_product_analyze.jsp?doc_id=")', 1000);
             } else {
             showTableNonPopup("show", "A_doc_id", "../JSP/CS_ShowD_carbon_send_product_analyze.jsp?doc_id=");
             }
            ...
            function OpenDoc_id(input)
            {
                switch (input) {
                    case 0:
                        openBrWindow('vd_carbon_send_product_header_analyze&stadment=and+doc_type+=+\'PT\'and+wh_leader_confirm+=+\'N\'and+quality_confirm+=+\'N\'', 28, 'Search_Doc_id.jsp');
                        break;
                    case 1:
                        openBrWindow('vd_carbon_send_product_header_analyze&stadment=and+doc_type+=+\'PT\'and+wh_leader_confirm+=+\'N\'and+quality_confirm+=+\'Y\'', 28, 'Search_Doc_id.jsp');
                        break;
                    case 2:
                        openBrWindow('vd_carbon_send_product_header_analyze&stadment=and+doc_type+=+\'PT\'and+wh_leader_confirm+=+\'Y\'', 28, 'Search_Doc_id.jsp');
                        break;
            ...
            /*
             function Open_Doc_Purchase_ID(input)
             {
             switch (input) {
             case 1:
             openBrWindow('vd_purchase_request_header_offer_compare&stadment\'', 52, 'Search_Config2.jsp');
             break;
             case 2:
             openBrWindow('vd_purchase_order_header&stadment\'', 52, 'Search_Config2.jsp');
             break;
             }
            ...
            function Record_Count() {
                AjaxRun_id("record_count1", "../JSP/CS_D_Carbon_Send_Count_Doc.jsp?runer_id=2");
            }
    ...
    <body onload="Start_Check_Record_Count()" >
        ...
        <form name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">
            <%
                ...
                objs_p = h_p.selectheaderscreen_process(objs_p, "CS_D_carbon_send_product_header2_analyze");
                ...
                String inputSQL = " select count(*) as num from vd_carbon_send_product_header where doc_type = 'PT' and  quality_confirm <> 'Y'   " ;
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-footer">                  
                            <table  cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    <td class="columnlabel1">จำนวนเอกสารที่ยังไม่ Approve</td>
