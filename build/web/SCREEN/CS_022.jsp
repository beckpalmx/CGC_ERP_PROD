    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function del()
            {
                ...
                confirmDelete_Data(this, "02", URLsend('doc_id,status_d,username,scale_no', '../JSP/CS_022.jsp'));
            }
                    ...
                    case 1:
                        if (getId("select_mbranch").value === "not")
                            //openBrWindow('Vd_rawmatt_receive&stadment=and+complete_flag+<>+\'Y\'+and+doc_type+=+\'N\'', 22, 'Search_Config2.jsp');
                                openBrWindow('Vd_rawmatt_receive&stadment=and+complete_flag+<>+\'Y\'+and+doc_type+=+\'N\'', 22, 'Search_ConfigRawMatt.jsp');                                
                        else
                            openBrWindow('Vd_rawmatt_receive&stadment=and+complete_flag+<>+\'Y\'+and+doc_type+=+\'N\'+and+location_id2+=+\'' + getId("select_mbranch").value + '\'', 22, 'Search_ConfigRawMatt.jsp');
                        break;
                    case 2:
                        if (getId("select_mbranch").value === "not")
                            openBrWindow('Vd_rawmatt_receive&stadment=and+complete_flag+<>+\'Y\'+and+doc_type+=+\'Y\'', 22, 'Search_ConfigRawMatt.jsp');
                        else
                            openBrWindow('Vd_rawmatt_receive&stadment=and+complete_flag+<>+\'Y\'+and+doc_type+=+\'Y\'+and+location_id2+=+\'' + getId("select_mbranch").value + '\'', 22, 'Search_ConfigRawMatt.jsp');
                        break;
                    case 3:
                        if (getId("select_mbranch").value === "not")
                            openBrWindow('Vd_rawmatt_receive&stadment=and+complete_flag+=+\'Y\'', 22, 'Search_ConfigRawMatt.jsp');
                        else
                            openBrWindow('Vd_rawmatt_receive&stadment=and+complete_flag+=+\'Y\'+and+location_id2+=+\'' + getId("select_mbranch").value + '\'', 22, 'Search_ConfigRawMatt.jsp');
                        break;
                    default:
                        break;
                }
            ...
            function Record_Count() {
                ...
                AjaxRun_id("record_count3", "../JSP/CS_046_Count_Doc.jsp?runer_id=3");
            }
            ...
            function Last_Doc_id() {
                AjaxRun_id("doc_id_last", "../JSP/CS_RAWMAT_RUN_DOC_ID.jsp?runer_id=2");
            }
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-footer">
                        ...
                        <table  cellpadding="0" cellspacing="0" >
                            <tr>
                                <td class="columnlabel1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;เอกสารที่ยังไม่มีผล LAB&nbsp;&nbsp;:&nbsp;&nbsp;</td>
                                <td colspan="3" class="columnobject">
                                    ...
                                    &nbsp;&nbsp;<b>รายการ</b>
                                <td class="columnlabel1">เอกสารที่ยังไม่อนุมัติผล LAB&nbsp;&nbsp;:&nbsp;&nbsp;</td>
                                <td class="columnobject">
                                    <input name='record_count2' type='button' class="cgcButton_22" id="record_count2" value='<%=record_count2%>'onclick="Record_Count();"/>
                                    &nbsp;&nbsp;<b>รายการ</b>        
                            </tr>          
                            <tr>
                                <td class="columnlabel1">เอกสารที่ยังไม่ได้รับเข้า Stock&nbsp;&nbsp;:&nbsp;&nbsp;</td>
                                <td colspan="3" class="columnobject">
                                    <input name='record_count3' type='button' class="cgcButton_22" id="record_count3" value='<%=record_count3%>'onclick="Record_Count();"/>
                                    &nbsp;&nbsp;<b>รายการ</b>    
                                <td class="columnlabel1">เลขที่เอกสารล่าสุด&nbsp;&nbsp;:&nbsp;&nbsp;</td>
                                <td class="columnobject">
                                    <input name='doc_id_last' type='button' class="cgcButton_22" id="doc_id_last" value='<%=doc_id_last%>'onclick="Last_Doc_id();"/>
                                    &nbsp;&nbsp;<b></b>                           
                            </tr>                                      
                        </table>
