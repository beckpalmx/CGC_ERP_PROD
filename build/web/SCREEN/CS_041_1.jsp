...
<html>
    <head>
        ...
        <script type="text/javascript">
            function goAdd() {
                ...
                {
                    getSave(URLsend('doc_id,wh_id,product_id,place_prd,palate_no,size,i2,bag,weight,remark,status_a,username,product_no,fraction_bag,doc_type,pack_repacking_status', '../JSP/CS_041_1.jsp'));
                    showTable("show", "doc_id", "../JSP/CS_Show041_1.jsp?doc_id=");
                    setTimeout('showTable("show","doc_id","../JSP/CS_Show041_1.jsp?doc_id=")', 800);
            ...
            function goEdit()
            {
                ...
                if (ChkParameter(arrayChk))
                {
                    getSave(URLsend('doc_id,line_no,wh_id,product_id,place_prd,palate_no,size,i2,bag,weight,remark,status_u,username,product_no,fraction_bag,doc_type,pack_repacking_status', '../JSP/CS_041_1.jsp'));
                    showTable("show", "doc_id", "../JSP/CS_Show041_1.jsp?doc_id=");
                    setTimeout('showTable("show","doc_id","../JSP/CS_Show041_1.jsp?doc_id=")', 800);
                    setTimeout('window.close()', 1000);
                }
    ...
    <%!    ThaiUtil en = new ThaiUtil();
        D_packing_product_detailDAO_40_1 objDAO = new D_packing_product_detailDAO_40_1();
                    ...
                    <div class="panel-footer">           
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    <input name="fraction_bag" type='text' class="inputs" id="fraction_bag" size="10" value="<%=fraction_bag%>" onblur="IsNuber(this.value, this)">&nbsp;(กิโลกรัม)</td>
                            </tr>
                            <tr>
