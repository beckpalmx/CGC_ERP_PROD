...
<html>
    ...
    <%!    String path, lookup, doc_eff_date, doc_id_last, doc_no;
    %>
    <head>
        ...
        <script type="text/javascript">
            ...
            function goDelChild()
            {
                ...
                {
                    SURL = "../JSP/CS_041.jsp?status_d=3&chk_all=1&username=" + getId("username").value;
                    SURL = SURL + "&doc_id=" + getId("doc_id").value;
                    Delete_Line_no_ShowTotal2(SURL, 'total_bag_withdraw,total_weight_withdraw');
                    showTableNonPopup("show", "doc_id", "../JSP/CS_Show041.jsp?doc_id=");
                    getId("chk_all").checked = false;
                }
                else//จะทำการลบข้อมูลเฉพาะ Datail ที่ทำการเลือกไว้
                {
                    SURL = "../JSP/CS_041.jsp?status_d=3&ckbox=";
                    ...
                    Delete_Line_no_ShowTotal2(SURL, 'total_bag_withdraw,total_weight_withdraw');
                    showTableNonPopup("show", "doc_id", "../JSP/CS_Show041.jsp?doc_id=");
                    setTimeout('showTableNonPopup("show", "doc_id", "../JSP/CS_Show041.jsp?doc_id=")', 500);
                }
            }
            function goDelChild2()
            {
                ...
                {
                    SURL = "../JSP/CS_044.jsp?status_d=3&chk_all=1&username=" + getId("username").value;
                    SURL = SURL + "&doc_id=" + getId("doc_id").value;
                    Delete_Line_no_ShowTotal2(SURL, 'total_bag,total_weight');
                    showTableNonPopup("show2", "doc_id", "../JSP/CS_Show044.jsp?doc_id=");
                    getId("chk_all2").checked = false;
                }
                else//จะทำการลบข้อมูลเฉพาะ Datail ที่ทำการเลือกไว้
                {
                    SURL = "../JSP/CS_044.jsp?status_d=3&ckbox=";
                    for (var i = 0; i < document.getElementsByName("ckbox2").length; i++)
                    {
                    ...
                    Delete_Line_no_ShowTotal2(SURL, 'total_bag,total_weight');
                    showTableNonPopup("show2", "doc_id", "../JSP/CS_Show044.jsp?doc_id=");
                    setTimeout('showTableNonPopup("show2", "doc_id", "../JSP/CS_Show044.jsp?doc_id=")', 500);
                }
            }
            ...
            function AddHeader()
            {
                ...
                {
                    //alert("test")
                    getSave(URLsend('chkNull,doc_id,doc_date,job_id,job_id_desc,time_from,time_to,emp_id,emp_id_desc,shift,wh_in,wh_out,lost_weight,total_bag_withdraw,total_weight_withdraw,total_bag,total_weight,username,runner_id,complete_flag,sum_pack_month,sum_pack_year', '../JSP/CS_040.jsp'));
                    getId("doc_id").disabled = false;
            ...
            function Delete()
            {
                ...
                if (r)
                {
                    getSave(URLsend('doc_id,doc_date,job_id,job_id_desc,time_from,time_to,emp_id,emp_id_desc,shift,wh_in,wh_out,lost_weight,total_bag_withdraw,total_weight_withdraw,total_bag,total_weight,status_d,username,runner_id', '../JSP/CS_040.jsp'));
                    getId("doc_id").disabled = false;
                    getId("show").innerHTML = "";
                    getId("show2").innerHTML = "";
                    getId("status_cancle").value = "";
            ...
            function Runing_Doc_id() {
                if (document.getElementById('doc_date').value === '') {
                    ...
                    AjaxRun_id("doc_id", "../JSP/CS_040_RUN_DOC_ID.jsp?runer_id=" + getId("doc_date").value);
                }
            }

            function Last_Doc_id() {
                AjaxRun_id("doc_id_last", "../JSP/CS_040_RUN_DOC_ID.jsp?runer_id=1");
            }
            ...
            function Record_Count() {
                AjaxRun_id("record_count1", "../JSP/CS_D_WH_Count_Doc.jsp?runer_id=3");
                AjaxRun_id("record_count1", "../JSP/CS_D_WH_Count_Doc.jsp?runer_id=10");
            }
        ...
        <link href="../CSS/cgc_button.css?v=1.0a" rel="stylesheet" type="text/css">
        <link rel="stylesheet" type="text/css" media="all" href="../JS/bootstrap/css/bootstrap.css" />        
        <link rel="stylesheet" type="text/css" media="all" href="../JS/bootstrap/css/bootstrap-select.css" />                
        <link rel="stylesheet" type="text/css" media="all" href="../JS/bootstrap/css/bootstrap-theme.css" />    
    ...
    <body onload="Start_Check_Last_Doc_ID();
        ...
        <form name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">
            <%
                ...
                String inputSQL = " select count(*) as num from vd_packing_product_header where complete_flag <> 'Y' and  count_send_complete <> '0'   ";
                int record_count1 = objuti.numRowdatabase(inputSQL);
                inputSQL = " select count(*) as num from vd_packing_product_header where complete_flag <> 'Y' and  count_send_complete = '0'   ";
                                ...
                                <table  cellpadding="0" cellspacing="0" >
                                    ...
                                    <tr>
                                        <td colspan="2" align="left">
                                            ...
                                            &nbsp;<input type='button' name='doc_id_last' data-toggle="tooltip" title="กดเพื่อดูเลขที่เอกสารล่าสุด หรือรอเพื่อ Update อัตโนมัติ" class="cgcButton_21" id="doc_id_last" value='<%=doc_id_last%>'onclick="Last_Doc_id();"/>                                            
                                        </td>
                                    </tr>                                   

                                    <tr>
                                        <td class="columnlabel1">เอกสารที่ยังไม่ส่งเข้าคลังสินค้า</td>
                                        <td class="columnobject">&nbsp;
                                            <input name='record_count2' type='button' class="cgcButton_22" id="record_count2" value='<%=record_count2%>'onclick="Record_Count();"/>
                                            &nbsp;&nbsp;<b>รายการ&nbsp;&nbsp;เอกสารที่ส่งคืนมาแก้ไข</b>
                                    ...
                                    <tr>
                                        ...
                                        <td width="607" class="columnobject">
                                            ...
                                            &nbsp;<a href='#' title="ค้นหาข้อมูลที่ทำการบรรจุ" onClick="openBrWindow('vd_packing_product_header&stadment=and+complete_flag+<>+\'Y\'+and+count_send_complete+=+\'0\'', 40, 'Search_Doc_id.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;
                                            <b>เอกสารกลับมาเพื่อแก้ไข</b>&nbsp;:&nbsp;<a href='#' title="ค้นหาข้อมูลที่ทำการบรรจุที่กลับมาจากคลังสินค้าเพื่อแก้ไข"  onClick="openBrWindow('vd_packing_product_header&stadment=and+complete_flag+<>+\'Y\'+and+count_send_complete+<>+\'0\'', 40, 'Search_Doc_id.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>
                                            <b>วันที่เอกสาร*</b>&nbsp;:&nbsp;
                                    ...
                                    <tr>
                                        ...
                                        <td class="columnobject">
                                            ...
                                            &nbsp;&nbsp;<b>ถึง</b>&nbsp;&nbsp;
                                            <input name='time_to' type='text' class="inputs" id="time_to" value='' size='10' />                                
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="columnobject">
                                            ...
                                            &nbsp;<a href='#' onClick="javascript:openBrWindow('Vemployee&stadment=and+status+=+\'Y\'and+dept_id+=+\'07\'', 40, 'Search_Config2.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;<input name='emp_id_desc' type='text' class="inputs" id="emp_id_desc" value='' size='30' readonly/>                                
                                        </td>
                                    </tr>
                                    <tr>
                                                ...
                                                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner">
                                                    <tr>
                                                        ...
                                                        <td colspan="5" class="btn_multi">
                                                            <input type='button' class="cgcButton_4" name='but1' value='  เพิ่ม  ' onClick="javascript:goAddChild(URLsend('doc_id,total_bag_withdraw,total_weight_withdraw,status_a,username', 'CS_041.jsp'));"/>
                                            ...
                                            <div style="width:100%;">
                                                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner">
                                                    <tr>
                                                        ...
                                                        <td colspan="5" class="btn_multi">
                                                            <input type='button' class="cgcButton_4" name='but3' value='  เพิ่ม  ' onClick="javascript:goAddChild(URLsend('doc_id,total_bag,total_weight,status_a,username', 'CS_044.jsp'));"/>
                                    ...
                                    <tr>
                                        ...
                                        <td class="columnobject"><input name="runner_id" type='text' class="inputs" id="runner_id" size="10" readonly>
                                            &nbsp;<a href='#' onClick="javascript:openBrWindow('Vemployee1&stadment=and+status+=+\'Y\'and+(dept_id+=+\'07\'or+dept_id+=+\'06\'or+dept_id+=+\'003\')', 40, 'Search_Config2.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;
