...
<html>
    <%!    String path, lookup, doc_eff_date, doc_no, doc_id, chk_dept;%>
    <head>
        ...
        <script type="text/javascript">
            ...
            function goDelChild()
            {
                ...
                else//จะทำการลบข้อมูลเฉพาะ Detail ที่ทำการเลือกไว้
                {
                    ...
                    /*
                     ...
                     alert("A_doc_id value = " + getId("A_doc_id").value);
                     alert("A_username = " + getId("A_username").value);
                     alert("SURL = " + SURL);
                     */
            ...
            function AddHeader()
            {
                ...
                if (r)
                {
                    ...
                    if (ChkParameter(arryChk)) {
                        ...
                        getSave(URLsend('chkNull,maxline,' + strID, '../JSP/CS_D_carbon_send_product_header.jsp'));
                        ResetValue();
                    }
                }
            ...
            function Delete()
            {
                ...
                if (r)
                {
                    getSave(URLsend('D_status,A_doc_id', '../JSP/CS_D_carbon_send_product_header.jsp'));
                    ResetValue();
                }
            ...
            {
                //alert("Dept ID = " + getId('dept_id').value);
                switch (input) {
                    case 1:
                        openBrWindow('vd_carbon_send_product_header&stadment=and+doc_type+=+\'PM\'and+wh_leader_confirm+=+\'N\'', 28, 'Search_Doc_id.jsp');
                        break;
                    case 2:
                        openBrWindow('vd_carbon_send_product_header&stadment=and+doc_type+=+\'PM\'and+wh_leader_confirm+=+\'Y\'', 28, 'Search_Doc_id.jsp');
                        break;
            ...
            function CreateNewRow()
            {
                ...
                if (intLine === 0) {
                    for (var i = 1; i <= 20; i++) {
                        ...
                        newCell.setAttribute("class", "forborder");
                        newCell.setAttribute("align", "center");
                        newCell.innerHTML = "<td><INPUT TYPE=\"text\" SIZE=\"15\" name=\"P_size\" ID=\"P_size_id_" + intLine + "\" VALUE=\"\"  onclick=\"openBrWindow(\'m_carbon_size&textinput=P_size_id_" + intLine + "\', 0, \'Search_Detail_Desc.jsp\')\" readonly></td>";
                    ...
                    newCell.setAttribute("class", "forborder");
                    newCell.setAttribute("align", "center");
                    newCell.innerHTML = "<td><INPUT   TYPE=\"text\" SIZE=\"20\" name=\"P_size\" ID=\"P_size_id_" + intLine + "\" VALUE=\"\"  onclick=\"openBrWindow(\'m_carbon_size&textinput=P_size_id_" + intLine + "\', 0, \'Search_Detail_Desc.jsp\')\" readonly></td>";
                    newCell = newRow.insertCell(6);
                    newCell.setAttribute("width", "10%");
                    newCell.setAttribute("class", "forborder");
                    newCell.setAttribute("align", "center");
            ...
            function CreateNewRow_Test()
            {
                ...
                if (intLine === 0) {
                    for (var i = 1; i <= 20; i++) {
                        ...
                        newCell.setAttribute("class", "forborder");
                        newCell.setAttribute("align", "center");
                        newCell.innerHTML = "<td   style=\"width: 100px;\" ><INPUT    TYPE=\"text\" SIZE=\"15\" name=\"P_job\" ID=\"P_job_id_" + intLine + "\" VALUE=\"134/2014\"  onclick=\"openBrWindow(\'vd_job_order_header&textinput=P_job_id_" + intLine + "\', 0, \'Search_Detail_Desc2.jsp\')\" readonly></td>";
                        newCell = newRow.insertCell(3);
                        newCell.setAttribute("width", "3%");
                        newCell.setAttribute("class", "forborder");
                        newCell.setAttribute("align", "center");
                    ...
                    newCell.setAttribute("class", "forborder");
                    newCell.setAttribute("align", "center");
                    newCell.innerHTML = "<td><INPUT    TYPE=\"text\" SIZE=\"15\" name=\"P_job\" ID=\"P_job_id_" + intLine + "\" VALUE=\"\"  onclick=\"openBrWindow(\'vd_job_order_header&textinput=P_job_id_" + intLine + "\', 0, \'Search_Detail_Desc2.jsp\')\" readonly></td>";
                    newCell = newRow.insertCell(3);
                    newCell.setAttribute("width", "5%");
                    newCell.setAttribute("class", "forborder");
                    newCell.setAttribute("align", "center");
            ...
            function Record_Count() {
                AjaxRun_id("record_count1", "../JSP/CS_D_Carbon_Send_Count_Doc.jsp?runer_id=3");
            }
    ...
    <body onload="Start_Check_Record_Count()">
        ...
        <form name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">
            <%
                ...
                String inputSQL = " select count(*) as num from vd_carbon_send_product_header where doc_type = 'PM' and  complete_flag <> 'Y'   ";
                int record_count1 = objuti.numRowdatabase(inputSQL);                
                //_______________________________________________________________report

                //Check Dept ID For warehouse 
                chk_dept = "0";
