        ...
        <script type="text/javascript">
            ...
            function Runing_Doc_id() {
                if (document.getElementById('doc_date').value === '') {
                    ...
                    AjaxRun_id("doc_id", "../JSP/CS_115.jsp?runer_id=" + getId("doc_date").value);
            }
    ...
    <body>
        <form name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">
            <%
                ...
                objs_p = h_p.selectheaderscreen_process(objs_p, "CS_115");
                                            ...
                                            <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner">
                                                <tr>
                                                    ...
                                                    <td colspan="6" class="btn_multi">
                                                        <input type='button' class="cgcButton_4" name='but1' value='  เพิ่ม  ' onClick="javascript:goAddChild(URLsend('doc_id,doc_date,doc_type,status_a,username', 'CS_116.jsp'))"/>
